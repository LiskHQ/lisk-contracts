...
contract MockERC20LST is ERC20 {
    ...
    ///         A 1-to-1 conversion corresponds to conversionRate = 1e18.
    uint256 private conversionRate;

    constructor(uint256 _conversionRate) ERC20("Mock LST Token", "mLST") {
        conversionRate = _conversionRate;
    }

    /// @notice Shortcut function to convert ETH to ERC20 token.
    receive() external payable {
        uint256 amount = msg.value * conversionRate / 1e18;
