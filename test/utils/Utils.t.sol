...
contract UtilsTest is Test {
    ...
    function test_readAndWriteL2AddressesFile() public {
        ...
        Utils.L2AddressesConfig memory config = Utils.L2AddressesConfig({
            ...
            L2MultiFeedAdapterWithoutRoundsMainDemo: address(index++),
            L2MultiFeedAdapterWithoutRoundsMainDemoImplementation: address(index++),
            L2MultiFeedAdapterWithoutRoundsPrimaryProd: address(index++),
            L2MultiFeedAdapterWithoutRoundsPrimaryProdImplementation: address(index++),
            L2PriceFeedLskWithoutRounds: address(index++),
            L2PriceFeedLskWithoutRoundsImplementation: address(index++),
            L2PriceFeedUsdtWithoutRounds: address(index++),
            L2PriceFeedUsdtWithoutRoundsImplementation: address(index++),
