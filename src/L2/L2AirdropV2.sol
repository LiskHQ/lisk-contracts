...
contract L2AirdropV2 is Ownable2Step {
    ...
    /// @notice The total amount of LSK tokens claimed during HodlerdropV2.
    uint256 public constant MIGRATION_AIRDROP_CLAIMED_AMOUNT =
        MIGRATION_AIRDROP_AMOUNT - MIGRATION_AIRDROP_UNCLAIMED_AMOUNT;
        ...
        Ownable(msg.sender)
    {
        ...
        require(_l2ClaimAddress != address(0), "L2AirdropV2: L2 Claim contract address can not be zero");
        require(
    ...
    function sendLSKToEcosystemWallet() public onlyOwner {
        ...
        require(
            airdropStartTime + (HODLER_AIRDROPV2_DURATION * 1 days) < block.timestamp,
