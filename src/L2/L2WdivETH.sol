...
///         use an L2WdivETH as the L2 representation of an WdivETH token on the L1.
contract L2WdivETH is IOptimismMintableERC20, ERC20, ERC20Permit {
    ...
    /// @param remoteTokenAddr Address of the corresponding L1 WdivETH token.
    ...
    /// @return Address of the corresponding L1 WdivETH token on the remote chain.
