...
// Reference:
// https://github.com/aurora-is-near/rainbow-bridge/blob/master/contracts/eth/nearbridge/contracts/Ed25519.sol
library Ed25519 {
        ...
        unchecked {
            ...
            // Step 1: compute SHA-512(R, A, M)
            {
                ...
                uint256 h0 = ((a + 0x6a09e667_f3bcc908) & 0xffffffff_ffffffff)
                    ...
                    | (((c + 0x3c6ef372_fe94f82b) & 0xffffffff_ffffffff) << 128) | ((d + 0xa54ff53a_5f1d36f1) << 192);
                ...
                uint256 h1 = ((e + 0x510e527f_ade682d1) & 0xffffffff_ffffffff)
                    ...
                    | (((g + 0x1f83d9ab_fb41bd6b) & 0xffffffff_ffffffff) << 128) | ((h + 0x5be0cd19_137e2179) << 192);
